			...
			<div className="border border-gray-400 bg-gray-100 px-3 md:px-8 pt-2 pb-6 mt-4 mb-7 rounded-lg shadow">
				...
				<div className="bg-gray-800 text-white rounded px-8 py-6 mt-3">
					...
					<p className="mb-4">
						...
						time. We will provide notice of any material changes by
					...
					<ul className="list-disc ml-6 mb-4">
						<li className="mb-2">
							<strong>Registration:</strong> To access certain features
							of the Service, you may be required to register for an
						...
						<li className="mb-2">
							<strong>Eligibility:</strong> You must be at least 10 years
							old to use our Service. By using the Service, you represent
					...
					<ul className="list-disc ml-6 mb-4">
						...
						<li className="mb-2">
							Prohibited conduct includes harassing or causing distress
							or inconvenience to any user, transmitting obscene or
							offensive content, or disrupting the normal flow of
							dialogue within our Service.
						</li>
						<li className="mb-2">
							Specifically for bracket challenges, you agree to abide by
							all rules and guidelines for participation as published on
							the Service.
						</li>
					</ul>
					...
					<p className="mb-4">
						...
						the laws of Republic of the Philippines, without regard to its
