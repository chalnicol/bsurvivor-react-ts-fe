				...
				<div className="border border-gray-400 bg-gray-100 p-2 md:p-3 mt-4 mb-7 rounded-lg shadow">
					...
					<div className="bg-gray-800 text-white rounded-b px-8 py-6">
						<p className="mb-2">
							...
							describes how BasketballSurvivor ("we," "us," or "our")
							collects, uses, and discloses your information when you
							visit and use our website and services.
						</p>
						<p className="mb-6">
						...
						<p className="mb-4">
							...
							users of our Service, including:
						</p>
						<ul className="list-disc ml-6 mb-4">
							<li className="mb-2">
								<strong>Personal Information:</strong> This includes
								information that can be used to identify you, such as
								your name, email address, and [any other personal data
								you collect, e.g., username, password (encrypted),
								location if used for services]. We collect this when you
								register for an account, participate in our bracket
								challenges, or contact us.
							</li>
							<li className="mb-2">
								<strong>Usage Data:</strong> We may collect information
								on how the Service is accessed and used. This Usage Data
							...
							<li className="mb-2">
								...
								and similar tracking technologies to track the activity
								on our Service and hold certain information. Cookies are
								files with a small amount of data which may include an
								anonymous unique identifier. You can instruct your
						...
						<ul className="list-disc ml-6 mb-4">
							...
							<li className="mb-2">
								To manage your account and participation in challenges
								(e.g., tracking your bracket, displaying leaderboard
								rankings).
							</li>
							<li className="mb-2">
								To send you updates, newsletters, and promotional
								materials (only if you've opted in).
							</li>
							<li className="mb-2">
						...
						<ul className="list-disc ml-6 mb-4">
							<li className="mb-2">
								...
								our Service is used. These third parties have access to
								your Personal Data only to perform these tasks on our
								behalf and are obligated not to disclose or use it for
								any other purpose.
							</li>
							<li className="mb-2">
								<strong>For Business Transfers:</strong> If we are
								involved in a merger, acquisition, or asset sale, your
								Personal Data may be transferred.
							</li>
							<li className="mb-2">
								<strong>For Law Enforcement:</strong> Under certain
						...
						<h2 className="text-2xl font-semibold  mt-8 mb-4">
							5. Your Data Protection Rights under the Data Privacy Act
							of 2012 in the Philippines
						</h2>
						<p className="mb-4">
						...
						<ul className="list-disc ml-6 mb-4">
							...
							<li className="mb-2">
								The right to withdraw consent at any time where [Your
								Website Name] relied on your consent to process your
						...
						<p className="mb-4">
							...
							becoming effective and update the "Last Updated" date at
