		...
		<ContentBase className="p-4">
			<div className="border border-gray-400 bg-gray-100 px-3 md:px-8 pt-2 pb-12 mt-4 mb-7 rounded-lg shadow">
				...
				<p className="mb-4">
					...
					how [Your Website Name] ("we," "us," or "our") collects, uses,
					and discloses your information when you visit and use our website
				...
				<ul className="list-disc ml-6 mb-4">
					<li className="mb-2">
						...
						name, email address, and [any other personal data you collect,
						e.g., username, password (encrypted), location if used for
						services]. We collect this when you register for an account,
						participate in our bracket challenges, or contact us.
					</li>
					<li className="mb-2">
				...
				<ul className="list-disc ml-6 mb-4">
					...
					<li className="mb-2">
						To manage your account and participation in challenges (e.g.,
						tracking your bracket, displaying leaderboard rankings).
					</li>
					<li className="mb-2">
				...
				<ul className="list-disc ml-6 mb-4">
					...
					<li className="mb-2">
						<strong>For Business Transfers:</strong> If we are involved in
						a merger, acquisition, or asset sale, your Personal Data may
						be transferred.
					</li>
					<li className="mb-2">
				...
				<h2 className="text-2xl font-semibold text-gray-700 mt-8 mb-4">
					5. Your Data Protection Rights (e.g., under the Data Privacy Act
				...
				<ul className="list-disc ml-6 mb-4">
					...
					<li className="mb-2">
						The right to withdraw consent at any time where [Your Website
						Name] relied on your consent to process your personal
						information.
					</li>
				</ul>
				<p className="mb-4">
